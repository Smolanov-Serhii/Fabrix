...
<div class="categories__container">
	...
	<p class="categories__sub block-subtitle">
		 Краткий текст о том, что у нас широкий ассортимент на любой вкус и можно выбрать по интересующим категориям.
	</p>
 ...
 </section> <section class="samples container">
...
<div class="samples__list">
 ...
 <img alt="Ткань для мужских костюмов" src="/bitrix/templates/bonzago/images/sample1.svg" class="svg">
	</div>
	...
	<div class="samples__img">
 <img alt="Ткань для мужских костюмов" src="/bitrix/templates/bonzago/images/sample2.svg" class="svg">
	</div>
	<div class="samples__desc">
		 Ткань для мужских костюмов
	</div>
	...
	<div class="samples__img">
 <img alt="Ткань для мужских костюмов" src="/bitrix/templates/bonzago/images/sample3.svg" class="svg">
	</div>
	<div class="samples__desc">
		 Ткань для мужских костюмов
	</div>
	...
	<div class="samples__img">
 <img alt="Ткань для мужских костюмов" src="/bitrix/templates/bonzago/images/sample4.svg" class="svg">
	</div>
	<div class="samples__desc">
		 Ткань для мужских костюмов
	</div>
...
<div class="range__container container">
 ...
 <img alt="4576 образцов тканей и трикотажа в наличии в Москве" src="/bitrix/templates/bonzago/images/range1.jpg">
		</div>
		<h3 class="range__desc">
		4576 образцов тканей и трикотажа в наличии в Москве </h3>
 </a> <a href="#" class="range__item">
		<div class="range__img">
 <img alt="Всегда актуальный ассортимент с детальным описанием материала" src="/bitrix/templates/bonzago/images/range2.jpg">
		</div>
		<h3 class="range__desc">
		Всегда актуальный ассортимент с детальным описанием материала </h3>
 </a> <a href="#" class="range__item">
		<div class="range__img">
 <img alt="2 новых проверенных поставщика за последнюю неделю" src="/bitrix/templates/bonzago/images/range3.jpg">
		</div>
		<h3 class="range__desc">
		2 новых проверенных поставщика за последнюю неделю </h3>
 </a> <a href="#" class="range__item">
		<div class="range__img">
 <img alt="5 профессиональных продакт-менеджеров ежедневно обновляют информацию о наличии" src="/bitrix/templates/bonzago/images/range4.jpg">
		</div>
		<h3 class="range__desc">
 ...
 </section> <section class="sample-order container">
...
<div class="sample-order__list">
 ...
 <img alt="Выберите материал для своей идеи и вдохновения" src="/bitrix/templates/bonzago/images/sample-order-1.svg">
		</div>
 ...
 <img alt="Удобный заказ образцов" src="/bitrix/templates/bonzago/images/sample-order-arrow.svg">
		...
		<div class="sample-order__icon">
 <img alt="Добавьте в корзину и укажите адрес" src="/bitrix/templates/bonzago/images/sample-order-2.svg">
		</div>
		<div class="sample-order__content">
 ...
 <img alt="Удобный заказ образцов" src="/bitrix/templates/bonzago/images/sample-order-arrow.svg">
		...
		<div class="sample-order__icon">
 <img alt="Устройтесь поудобнее и расслабтесь. Доставим образцы до вашей двери" src="/bitrix/templates/bonzago/images/sample-order-3.svg">
		</div>
		<div class="sample-order__content">
...
<div class="suppliers__container">
 ...
 </section> <section class="control container">
...
<div class="control__list">
 ...
 <img alt="Выставлен счет, ожидается оплата" src="/bitrix/templates/bonzago/images/control-1.svg">
			</div>
 ...
 <img src="/bitrix/templates/bonzago/images/control-next.svg" alt="Далее">
	...
	<div class="control__item">
		<div class="control__top">
			<div class="control__image">
 <img alt="Счет оплачен, товар в производстве, деньги зарезервированы" src="/bitrix/templates/bonzago/images/control-2.svg">
			</div>
			<div class="control__arrow">
 <img src="/bitrix/templates/bonzago/images/control-next.svg" alt="Далее">
			</div>
	...
	<div class="control__item">
		<div class="control__top">
			<div class="control__image">
 <img alt="Товар произведен, идет проверка качества" src="/bitrix/templates/bonzago/images/control-3.svg">
			</div>
			<div class="control__arrow">
 <img src="/bitrix/templates/bonzago/images/control-next.svg" alt="Далее">
			</div>
	...
	<div class="control__item">
		<div class="control__top">
			<div class="control__image">
 <img alt="Товар поступил на склад в Москве, ожидается отгрузка клиенту" src="/bitrix/templates/bonzago/images/control-4.svg">
			</div>
			<div class="control__arrow">
 <img src="/bitrix/templates/bonzago/images/control-next.svg" alt="Далее">
			</div>
 ...
 <img src="/bitrix/templates/bonzago/images/control-next.svg" alt="Далее">
	...
	<div class="control__item">
		<div class="control__top">
			<div class="control__image">
 <img alt="Товар получен, резервированные деньги списаны" src="/bitrix/templates/bonzago/images/control-6.svg">
			</div>
			<div class="control__arrow">
