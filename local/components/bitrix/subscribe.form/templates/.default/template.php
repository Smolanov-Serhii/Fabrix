...
<!--		</label><br />-->
<!--	--><?//endforeach;?>
        <input class="footer__subscribe-input" type="text" name="sf_EMAIL" placeholder="Ваш E-mail" size="20" value="" title="<?=GetMessage("subscr_form_email_title")?>" />
        <input class="footer__subscribe-send button" type="submit" name="OK" value="<?=GetMessage("subscr_form_button")?>" />
	</form>
<?
$frame->beginStub();
?>
